...
public class SmartHomePanel extends Application {
    ...
    private static final String IMAGES = "file:D:/SmartHome/Project/resources/images/";
    ...
    public VBox livingACCard() {
        ...
        toggle.setOnAction(e ->
                livingRoom.setAcOn(!livingRoom.isAcOn())
        );
    ...
    public VBox livingTVCard() {
        ...
        toggle.setOnAction(e ->
                livingRoom.setTvOn(!livingRoom.isTvOn())
        );
    ...
    public VBox livingCurtainsCard() {
        ...
        toggle.setOnAction(e ->
                livingRoom.setCurtainsOn(!livingRoom.isCurtainsOn())
        );
    ...
    public VBox buildMasterRoom() {
        ...
        actions.getChildren().addAll(sleep, romance, relax);
